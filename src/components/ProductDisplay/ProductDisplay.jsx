...
function ProductDisplay(props) {
    ...
    const handleAddToCart = async () => {
        if (selectedVariantIndex !== null) {
            ...
            const selectedVariantColor = selectedVariant.color;
            try {
                ...
                <div className="box-product-detail__right">
                    <div className="box-price1">
                        ...
                        <div className="item-price-percent">
                            <p className="item-rice-percent-detail" style={{fontWeight: 'bolder', backgroundColor: '#389d2d', padding: '4px', borderRadius: '17px', color: '#ffffff'}}>
                                Giảm &nbsp;
